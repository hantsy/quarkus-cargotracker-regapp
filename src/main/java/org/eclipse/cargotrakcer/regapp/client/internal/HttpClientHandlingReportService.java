...
public class HttpClientHandlingReportService implements HandlingReportService {
    ...
    public CompletableFuture<? extends HandlingResponse> submitReport(HandlingReport report) {
        ...
        return this.client
                ...
                .thenApply(res -> res.statusCode() == 202 ? new HandlingResponse.Success() : new HandlingResponse.Failed(res.body()))
                .toCompletableFuture();
    }
